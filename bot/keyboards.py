...
def get_admin_keyboard() -> InlineKeyboardMarkup:
    ...
    keyboard = [
        [
            ...
            InlineKeyboardButton(text="➖ Видалити", callback_data="admin_remove"),
        ],
        [
...
def get_confirm_keyboard(action: str, user_id: str) -> InlineKeyboardMarkup:
    ...
    keyboard = [
        [
            InlineKeyboardButton(text="✅ Підтвердити", callback_data=f"confirm_{action}_{user_id}"),
            InlineKeyboardButton(text="❌ Скасувати", callback_data="admin_back"),
        ],
    ]
    return InlineKeyboardMarkup(keyboard)
